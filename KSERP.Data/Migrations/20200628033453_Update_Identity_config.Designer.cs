...
namespace KSERP.Data.Migrations
{
    ...
    [Migration("20200628033453_Update_Identity_config")]
    partial class Update_Identity_config
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KSERP.Data.Entities.System.AppConfig", b =>
                {
            ...
            modelBuilder.Entity("KSERP.Data.Entities.System.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("KSERP.Data.Entities.System.RolePosition", b =>
                {
            ...
            modelBuilder.Entity("KSERP.Data.Entities.System.SystemActivity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("KSERP.Data.Entities.System.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("KSERP.Data.Entities.Oganization.Employee", b =>
                {
                    b.HasOne("KSERP.Data.Entities.System.User", "User")
                        .WithOne("Employee")
                        .HasForeignKey("KSERP.Data.Entities.Oganization.Employee", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("KSERP.Data.Entities.System.RolePosition", b =>
                {
                    ...
                    b.HasOne("KSERP.Data.Entities.System.Role", "Role")
                        .WithMany("RolePositions")
